...
export const informationFailure = createAction(INFORMATION_FAILURE)<error>();
...
export const getGraduateInformationSuccess = createAction(
  GET_GRADUATE_INFORMATION_SUCCESS,
)<getGraduateInformationType>();
export const getGraduateInformationFailure = createAction(
  GET_GRADUATE_INFORMATION_FAILURE,
)<error>();
...
export const gedScore = createAction(GED_SCORE)<number>();
