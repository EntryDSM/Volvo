  ...
  return (
    <S.ModalWrapper>
      <S.ModalNotice>
        ...
        <S.ModalNoticeText>
          {`1. 검정고시 합격자와 졸업예정자 및 졸업자의 화면이 다릅니다.\n    검정고시 합격자이신 경우, 학교 입력창이 있으면 전형 선택을 다시 한 번 확인해 주세요.`}
        </S.ModalNoticeText>
        <S.ModalNoticeText>
        ...
        <S.ModalNoticeText>
          5. 자동저장은 입력하고 3초동안 변화가 없으면 자동저장됩니다.
        </S.ModalNoticeText>
        <S.ModalNoticeSubTitle>성적 입력</S.ModalNoticeSubTitle>
        <S.ModalNoticeText>
          1. 해당 학기에 배우지 않은 과목은 x 로 선택하시면 됩니다.
        </S.ModalNoticeText>
        <S.ModalNoticeText>
        ...
        <S.ModalNoticeText>
          {`1. 이전에 작성하지 않은 부분이 있거나, 잘못 체크된 부분이 있으면 제출되지 않습니다. \n    오류가 발생할 경우 이전에 작성한 부분을 확인해 주세요.`}
        </S.ModalNoticeText>
        <S.ModalNoticeText>
