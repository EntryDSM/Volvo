...
export const information = async (
  ...
  try {
    ...
    return await request.patch(uri.information, informationRequest);
  } catch (error) {
    throw error;
  }
};
...
export const graduateInformation = async (
  ...
  try {
    const request = getRequestWithAccessToken(access_token);
    return await request.patch(uri.graduateInformation, graduateInformationRequest);
  } catch (error) {
    throw error;
  }
};
...
export const gedScore = async (access_token: string, gedScoreRequest: number) => {
  try {
    ...
    await request.patch(uri.gedScore, {
      ged_average_score: gedScoreRequest,
    });
  } catch (error) {
    throw error;
  }
